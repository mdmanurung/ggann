...
generates the family examples from `pbmc68k_reduced`, Scanpy's bundled PBMC
subset, so this page renders without a download. The publication pair is
generated from PBMC3K by `examples/vignettes/05_publication_panels.py`.
